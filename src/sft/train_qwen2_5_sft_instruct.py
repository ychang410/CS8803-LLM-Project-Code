...
def parse_args():
    parser = argparse.ArgumentParser(
        description="SFT Qwen/Qwen2.5-0.5B-Instruct on llmf25/llmf25data"
    )
    ...
    parser.add_argument(
        ...
        help="Base Qwen2.5 Instruct model to fine-tune.",
    )
    parser.add_argument(
        "--dataset_name",
        type=str,
    ...
    parser.add_argument(
        "--output_dir",
        type=str,
        default="qwen2_5_0_5b_instruct_llmf25_sft",
    ...
    parser.add_argument(
        "--num_train_epochs", type=float, default=1.5, help="Number of epochs."
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--learning_rate", type=float, default=1.5e-5, help="Peak learning rate."
    )
    parser.add_argument(
...
def main():
    ...
    logger.info("***** Starting Qwen2.5-0.5B-Instruct SFT *****")
